export const items = [
        {
        id: 1,
        category: "MÓN KHAI VỊ - APPERTIZERS",
        lists: [
            {
                foodId: "A1",
                foodName: "Crispy Shrimp In A Delicate Batter (8 shrimps)",
                foodNameTranslated: "Tôm Chiên Bột",
                foodPrice: "9.95"
            },
            {
                foodId: "A2",
                foodName: "Beef Sate skewers (3 skewers per order)",
                foodNameTranslated: "Bò Lụi",
                foodPrice: "8.95"
            },
            {
                foodId: "A3",
                foodName: "Grilled prawn skewers (12 shrimps)",
                foodNameTranslated: "Tôm Lụi",
                foodPrice: "9.95"
            },
            {
                foodId: "A4",
                foodName: "Combo: 2 beef sate skewers and 1 prawn skewer",
                foodNameTranslated: "Bò và Tôm Lụi",
                foodPrice: "9.25"
            },
            {
                foodId: "A5",
                foodName: "Deep fried squids",
                foodNameTranslated: "Mực Chiên Dòn",
                foodPrice: "9.50"
            },
            {
                foodId: "A6",
                foodName: "Deep fried wontons",
                foodNameTranslated: "Hoành Thánh Chiên Dòn",
                foodPrice: "7.95"
            },
            {
                foodId: "A7",
                foodName: "Marinated pork ball (3 skewers)",
                foodNameTranslated: "Nem Nướng Viên",
                foodPrice: "7.95"
            },
            {
                foodId: "A8",
                foodName: "Marinated pork ball (1 skewer) and Beef Skewers (2 skewers)",
                foodNameTranslated: "Nem Nướng Viên và Bò Lụi",
                foodPrice: "8.95"
            },
            {
                foodId: "A9",
                foodName: "Fried Fish Cake",
                foodNameTranslated: "Chả Cá",
                foodPrice: "9.25"
            },
            {
                foodId: "A10",
                foodName: "Fried Fish Cake, Marinated Pork Ball, Beef Skewer",
                foodNameTranslated: "Chả Cá, Nem Nướng Viên và Bò Lụi",
                foodPrice: "9.95"
            },
            {
                foodId: "A11",
                foodName: "Papaya Salad",
                foodNameTranslated: "Gỏi Đu Đủ",
                foodPrice: "8.95"
            },
            {
                foodId: "17",
                foodName: "Deep fried spring rolls (4 per order)",
                foodNameTranslated: "Chả Giò",
                foodPrice: "8.25"
            },
            {
                foodId: "17A",
                foodName: "Deep fried Vegetarian spring rolls (4 per order)",
                foodNameTranslated: "Chả Giò Chay",
                foodPrice: "8.25"
            },
            {
                foodId: "18",
                foodName: "Shrimps Salad Rolls (3 per order)",
                foodNameTranslated: "Gỏi Cuốn Tôm",
                foodPrice: "8.25"
            },
            {
                foodId: "18A",
                foodName: "Vegetarian Salad Rolls (3 per order)",
                foodNameTranslated: "Gỏi Cuốn Chay",
                foodPrice: "7.25"
            },
            {
                foodId: "18B",
                foodName: "Chicken Salad Rolls (3 per order)",
                foodNameTranslated: "Gỏi Cuốn Gà",
                foodPrice: "8.25"
            },
            {
                foodId: "19",
                foodName: "Chicken Wings (BBQ, Honey Garlic, Salt and Pepper, Crispy Wings, Hot Wings) - (8 per order)",
                foodNameTranslated: "Cánh Gà Chiên",
                foodPrice: "8.95"
            },
        ]
    },
    {
        id: 2,
        category: "BÁNH MÌ - VIETNAMESE SUB",
        note: "(All subs come with mayonnaise, cheese, onions, cucumbers, pickle carrot, chili, cilantro, sweet soya sauce)",
        lists: [
            {
                foodId: "S1",
                foodName: "Sate beef and chicken Sub",
                foodNameTranslated: "Bánh Mì Gà, Bò Saté",
                foodPrice: "10.75"
            },
            {
                foodId: "S2",
                foodName: "Sate chicken Sub",
                foodNameTranslated: "Bánh Mì Gà Saté",
                foodPrice: "9.75"
            },
            {
                foodId: "S2",
            ...
            {
                foodId: "S3",
                foodName: "Sate Beef Sub",
                foodNameTranslated: "Bánh Mì Bò Saté",
                foodPrice: "9.75"
            },
            {
                foodId: "S4",
                foodName: "Charbroiled Pork Sub",
                foodNameTranslated: "Bánh Mì Heo Nướng",
                foodPrice: "9.75"
            },
            {
                foodId: "S5",
                foodName: "Marinated Pork Patty Sub",
                foodNameTranslated: "Bánh Mì Nem Nướng",
                foodPrice: "9.75"
            },
            {
                foodId: "S6",
                foodName: "Grilled Beef Skewers Sub",
                foodNameTranslated: "Bánh Mì Bò Lụi",
                foodPrice: "9.95"
            },
            {
                foodId: "S7",
                foodName: "Grilled Prawn Skewers Sub",
                foodNameTranslated: "Bánh Mì Tôm Nướng",
                foodPrice: "11.75"
            }
        ]
    },
    ...
    {
        id: 4,
        category: "HOÀNH THÁNH - WONTON NOODLE SOUP",
        lists: [
            {
                foodId: "16A",
    ...
    {
        id: 9,
        category: "GIẢI KHÁT - BEVERAGE",
        lists: [
            {
                foodId: "31",
                foodName: "Hot Chocolate",
                foodNameTranslated: "Sữa Chocolate Nóng",
                foodPrice: "9.95"
            },
            {
                foodId: "31B",
                foodName: "Vietnamese hot honey lemon",
                foodNameTranslated: "Chanh Mật Ong Nóng",
                foodPrice: "9.95"
            },
            {
                foodId: "32",
                foodName: "Hot Vietnamese coffee with condensed milk",
                foodNameTranslated: "Cà Phê Sữa Nóng",
                foodPrice: "9.95"
            },
            {
                foodId: "33",
                foodName: "Iced Vietnamese coffee with condensed milk",
                foodNameTranslated: "Cà Phê Sữa Đá",
                foodPrice: "9.95"
            },
            {
                foodId: "34",
                foodName: "Pop: C Plus, Pepsi, Coke, Ginger Ales, Sprite, Nestea, Rootbeer",
                foodNameTranslated: "Nước Ngọt",
                foodPrice: "9.95"
            },
            {
                foodId: "35",
                foodName: "Fresh lemon juice",
                foodNameTranslated: "Đá Chanh",
                foodPrice: "9.95"
            },
            {
                foodId: "36",
                foodName: "Fresh orange juice",
                foodNameTranslated: "Cam Vắt",
                foodPrice: "9.95"
            },
            {
                foodId: "37",
                foodName: "Fresh coconut juice",
                foodNameTranslated: "Nước Dừa",
                foodPrice: "9.95"
            },
            {
                foodId: "39",
                foodName: "Triple scoop of vanilla ice cream over peanut and condense milk",
                foodNameTranslated: "Kem Tráng Miệng",
                foodPrice: "9.95"
            },
            {
                foodId: "40",
                foodName: "Deep fried banana with double scoop of vanilla ice cream over peanut and condense milk",
                foodNameTranslated: "Kem Chuối Chiên Sữa Đậu Phộng",
                foodPrice: "9.95"
            },
            {
                foodId: "40",
                foodName: "Deep fried banana over peanut and condense milk",
                foodNameTranslated: "Chuối Chiên Sữa Đậu Phộng",
                foodPrice: "9.95"
            },
        ]
    },
